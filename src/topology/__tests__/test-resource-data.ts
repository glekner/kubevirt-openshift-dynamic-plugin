import { ImagePullPolicy, K8sResourceKind } from '@kubevirt-types';
...
export const sampleReplicationControllers = {
  loaded: true,
  loadError: '',
  data: [
    {
...
export const sampleReplicaSets = {
  loaded: true,
  loadError: '',
  data: [
    {
...
export const sampleStatefulSets = {
  loaded: true,
  loadError: '',
  data: [
    {
...
export const sampleClusterServiceVersions = {
  data: [
    {
