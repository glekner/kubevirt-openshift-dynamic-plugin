...
import { GroupVersionKind, K8sKind, K8sResourceCommon } from '@kubevirt-types';
import { ExtensionK8sGroupModel } from '@openshift-console/dynamic-plugin-sdk/lib/api/common-types';
